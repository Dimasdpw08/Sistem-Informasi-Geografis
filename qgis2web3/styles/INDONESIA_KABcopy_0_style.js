...
var style_INDONESIA_KABcopy_0 = function(feature, resolution){
    ...
    var value = feature.get("Ht_Bintang");
    var labelText = "";
    size = 0;
    ...
    if (value > 0.000000 && value <= 5.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 10.000000 && value <= 35.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 35.000000 && value <= 64.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 64.000000 && value <= 100.000000) {
            style = [ new ol.style.Style({
